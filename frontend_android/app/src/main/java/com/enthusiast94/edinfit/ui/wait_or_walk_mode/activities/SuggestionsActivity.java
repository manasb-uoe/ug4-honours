...
public class SuggestionsActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_SELECTED_ORIGIN_STOP_ID = "selectedOriginStopId";
    public static final String EXTRA_SELECTED_SERVICE_NAME = "selectedServiceName";
    public static final String EXTRA_SELECTED_DESTINATION_STOP_ID = "selectedDestinationStopId";
    public static final String EXTRA_SELECTED_ROUTE_DESTINATION = "selectedRouteDestination";
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    ...
                    return SuggestionsFragment.newInstance(selectedOriginStopId, selectedServiceName,
                            selectedDestinationStopId, selectedRouteDestination);
                case 1:
